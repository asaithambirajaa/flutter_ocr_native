...
/// Shows Name, Address, and masked Aadhaar number.
    ...
    if (fields.isEmpty) {
      return Card(
        child: Padding(
          ...
          child: Text('No details found', style: Theme.of(context).textTheme.bodyMedium),
        ),
      );
    }
    ...
    final displayFields = showAllFields
        ...
        : Map.fromEntries(
            fields.entries.where((e) =>
                e.key == 'Name' || e.key == 'Address' || e.key == 'Aadhaar No.'),
          );
        ...
        child: Column(
          ...
          children: [
            ...
            ...displayFields.entries.map((entry) {
              ...
              if (maskAadhaar && entry.key == 'Aadhaar No.') {
